...
import imageio
import numpy as np
from config_loader import get_config, get_evo1_config
...
def datacenter_obs_to_maniflow(obs: Dict[str, Any], prompt: str = "do something.", resize_size: int = 448, arm_dofs: int = 7) -> Dict[str, Any]:
    """将 datacenter 观测转为发给策略的 JSON。"""
    if "image" not in obs:
        return {}
